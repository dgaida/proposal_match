...
- Correct changelog paths and add test coverage artifacts  
- Docs changelog, add coverage and link checker  
- Correct documentation paths and enhance CI/CD  
- Docs paths, add coverage and monthly link checker  
